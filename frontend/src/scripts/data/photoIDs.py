...
# Filtering out the inactive players
active_players = [player for player in players if player[player_index_is_active]]

# Transforming the list into the desired JSON structure
players_json_list = [
    {
        "player_index_id": player[player_index_id],
        "player_index_last_name": player[player_index_last_name],
        "player_index_first_name": player[player_index_first_name],
        "player_index_full_name": player[player_index_full_name]
    }
